...
_parser.add_argument("--bank", default=str(OUT / "qa_auto_source_v4.json.keep"))
_parser.add_argument("--filtered", default=str(OUT / "qa_auto_source_v4_strict.json"))
_parser.add_argument("--audit", default=str(OUT / "v4_strict_audit.csv"))
_parser.add_argument("--summary", default=str(OUT / "v4_strict_summary.txt"))
_parser.add_argument("--ckpt", default=str(OUT / "v4_strict_ckpt.json"))
_args, _ = _parser.parse_known_args()
BANK = Path(_args.bank)
FILTERED = Path(_args.filtered)
AUDIT = Path(_args.audit)
